...
const CompanyOwnerRegister = () => {
  ...
  const saveUserData = async (user, name, phone, email, companyName) => {
    try {
      await setDoc(doc(db, "companyOwner", user.uid), {
      ...
      console.log("Company Owner registered successfully:", user)
      navigate("/")
    } catch (error) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <h1 className="text-2xl font-bold text-center mb-2">Company Owner Register</h1>
        <p className="text-gray-600 text-center mb-6">Create your Company Owner account</p>
