    ...
    return (
        <div className="card flex justify-content-center overflow-auto">
            <Sidebar visible={sidebarVisible} onHide={() => setSidebarVisible(false)}
                showCloseIcon={false} className="w-full p-5 bg-gray-100 shadow-2xl md:w-20rem lg:w-30rem">
                <h1>Menu Bar</h1>
                <div className=" w-full px-1 py-5">
                    <ul className='flex flex-col w-full items-start gap-2  '>
                        ...
                        <li className='hover:bg-black w-full hover:text-white p-2 rounded-lg' onClick={() => navigate('/DailyReminder')}>
                            <Button label=" Daily Reminder"
                        ...
                        <li className='hover:bg-black w-full hover:text-white p-2 rounded-lg' onClick={() => navigate('/AddNewLead')}>
                            <Button label="Add New Lead"
                        ...
                        <li className='hover:bg-black w-full hover:text-white p-2 rounded-lg' onClick={() => navigate('/Settings')}>
